...
// Mock ConnectButton to preserve existing UI structure
const ConnectButton = {
  Custom: ({ children }: { children: (props: any) => React.ReactElement }) => {
...
const DepositModal = dynamic(
  () =>
    import("@/components/wallet/DepositModal").then((mod) => ({
      default: mod.DepositModal,
    })),
  {
    ssr: false,
    loading: () => null,
                                  ...
                                  <div className="relative h-9 w-9 rounded-xl overflow-hidden">
                                    {isLoadingProfile ? (
                                      ...
                                      <Image
                                        src={
                                          userAvatar ||
                                          getProfilePicture(account.address)
                                        }
                                        alt="Profile"
                                        fill
                                        sizes="36px"
