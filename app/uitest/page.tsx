...
export default function UITestPage() {
  ...
  const [selectedTimeframe, setSelectedTimeframe] = useState<
    "24h" | "7d" | "30d" | "all"
  >("24h");
  const [selectedMarketDetails, setSelectedMarketDetails] =
    useState<Market | null>(null);
  const [loadingMarketDetails, setLoadingMarketDetails] = useState(false);
  const [selectedTradingMarket, setSelectedTradingMarket] =
    useState<Market | null>(null);
  ...
  const handleBuy = async (market: Market, outcomeId: number) => {
    ...
    try {
      ...
      if (balance < buyAmount) {
        ...
        alert(
          `❌ Insufficient ${tokenSymbol} balance. You have ${balance.toFixed(
            4,
          )}, need at least ${buyAmount}.\n\nGet testnet USDT at: https://faucet.celo.org or mint via contract.`,
        );
        return;
      }
  ...
  const handleSell = async (market: Market, outcomeId: number) => {
    ...
    try {
      ...
      alert(
        `✅ Successfully sold shares for outcome ${outcomeId}!\n\n🔄 Refreshing market data...`,
      );
            ...
            <TabsContent value="markets" className="space-y-4">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Responsive grid of market cards for homepage
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  {loading && (
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Fetching ALL markets (open, closed, resolved) - USDT token -
                    Network ID: 11142220
                  </CardDescription>
                </CardHeader>
                <CardContent>
                              ...
                              <div className="pt-2 border-t">
                                ...
                                <div className="space-y-2">
                                  {market.outcomes.map((outcome) => {
                                    const userShareBalance =
                                      userShares[market.id]?.[outcome.id] || 0;
                                      ...
                                      >
                                        <div className="flex justify-between items-center">
                                          <div className="flex items-center gap-2 flex-1">
                                            ...
                                            {outcome.price_change_24h !==
                                              undefined &&
                                              outcome.price_change_24h !==
                                                0 && (
                                                <span
                                                  className={`text-xs ${
                                                    outcome.price_change_24h > 0
                                                      ? "text-green-500"
                                                      : "text-red-500"
                                                  }`}
                                                >
            ...
            <TabsContent value="chart" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Real-time market probability trends over time
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        ...
                        >
                          {selectedMarketSlug
                            ? markets.find((m) => m.slug === selectedMarketSlug)
                        ...
                        {markets.map((market) => (
                          <DropdownMenuItem
                            ...
                            onClick={async () => {
                              ...
                              try {
                                const marketDetails = await fetchMarket(
                                  market.slug,
                                );
                  ...
                  {loading || loadingMarketDetails ? (
                    ...
                    selectedMarketDetails.outcomes ? (
                    <div className="space-y-2">
                      <ProbabilityChart
                    ...
                    <div className="flex items-center justify-center h-[400px] border-2 border-dashed border-muted-foreground/25 rounded-lg">
                      <p className="text-muted-foreground">
                        Select a market above to view probability chart
                      </p>
                    </div>
                  )}
                </CardContent>
            ...
            <TabsContent value="trading" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Buy and sell outcome shares with real-time calculations
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  {/* Market Selector */}
                  <div className="space-y-2">
                    ...
                    <DropdownMenu>
                      ...
                      >
                        ...
                        {markets.filter((m) => m.state === "open").length ===
                          0 && (
            ...
            <TabsContent value="list" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Test market cards, filters, and list layouts
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center justify-center h-64 border-2 border-dashed border-muted-foreground/25 rounded-lg">
                    <p className="text-muted-foreground">
                      Market list components will be tested here
                    </p>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Rotating curved line with easing animation (fast at
                      bottom, slow at top)
                    </p>
                  ...
                  <div className="flex items-center justify-center h-32 border-2 border-dashed border-muted-foreground/25 rounded-lg">
                    <p className="text-muted-foreground">
                      Additional button components will be tested here
                    </p>
                  </div>
                </CardContent>
              </Card>
