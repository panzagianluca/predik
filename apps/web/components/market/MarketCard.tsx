...
export function MarketCard({ market }: MarketCardProps) {
  ...
  return (
    <a
      ...
      className="block w-full rounded-xl overflow-hidden transition-all duration-200 ease-in-out bg-[hsl(var(--card))]/90 backdrop-blur-md border border-[hsl(var(--border))] hover:shadow-lg hover:-translate-y-1"
    >
      {/* Header Section */}
