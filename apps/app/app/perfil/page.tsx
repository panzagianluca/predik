...
const TransactionsList = dynamic(
  () =>
    import("@/components/profile/TransactionsList").then((mod) => ({
...
const PositionsList = dynamic(
  () =>
    import("@/components/profile/PositionsList").then((mod) => ({
      default: mod.PositionsList,
    })),
  {
    ssr: false,
    loading: () => (
            ...
            <Card className="p-6 h-fit">
              ...
              <div>
                <p className="text-sm">
                  ...
                  {joinedDate} - {activeDays} días activos
                </p>
              </div>
            </Card>
